...
void B_PLUS_TREE_INTERNAL_PAGE_TYPE::Insert(const KeyType &key, const ValueType &value,
  ...
  if (size > GetMaxSize()) {
    throw std::logic_error(
        "Internal node has already reached over maxsize, "
        "which should be less than or equal to Maxsize.");
  }
...
INDEX_TEMPLATE_ARGUMENTS
auto B_PLUS_TREE_INTERNAL_PAGE_TYPE::FindValueIndex(const ValueType &value) const -> int {
